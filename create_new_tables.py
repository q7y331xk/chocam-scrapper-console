from config import RDS_CALCULATED_TABLE, RDS_PROCESSED_TABLE, RDS_RAW_TABLE
...
def create_tables_if_exists_drop(raw_table, processed_table, calculated_table):
...
create_tables_if_exists_drop(RDS_RAW_TABLE, RDS_PROCESSED_TABLE, RDS_CALCULATED_TABLE)